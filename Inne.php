...
<style>
    #obraz 
    {
        background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.4)), url('https://images.squarespace-cdn.com/content/v1/5ea9ec8fdd995955ed38dcdd/62dda88d-76ca-4e61-acb9-a79b42ed5263/midnys.jpg') center/cover no-repeat;
    }
...
<main>
  ...
  <section id="oferta">
    <h1>Inne</h1>
    <p class="intro">
      Słodka oprawa wielkich chwil – nasze torty to połączenie wyjątkowego smaku i efektownego wyglądu.
    </p>
  </section>
  </div>
