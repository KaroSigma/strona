...
<head>
    <meta charset="utf-8">
    <title>Torty – Słodka Bułka</title>
...
<style>
    #obraz 
    {
        background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.4)), url('https://piekarniagwozdz.pl/wp-content/uploads/2024/07/MG_9713-scaled.jpeg') center/cover no-repeat;
    }
