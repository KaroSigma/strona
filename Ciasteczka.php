...
<head>
    <meta charset="utf-8">
    <title>Ciasteczka – Słodka Bułka</title>
...
<style>
    #obraz 
    {
        background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.4)), url('https://www.carrefour.pl/images/globalproductlist/org/przepis-na-kruche-ciasteczka-wiatraczki-iegfjb.jpg') center/cover no-repeat;
    }
