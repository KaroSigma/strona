...
<head>
    <meta charset="utf-8">
    <title>Babeczki – Słodka Bułka</title>
...
<style>
    #obraz 
    {
        background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.4)), url('https://frytkownica-beztłuszczowa.pl/wp-content/uploads/2025/02/Babeczki-czekoladowe-w-airfryer.webp') center/cover no-repeat;
    }
