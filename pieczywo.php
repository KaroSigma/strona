...
<head>
    <meta charset="utf-8">
    <title>Pieczywo – Słodka Bułka</title>
...
<style>
    #obraz 
    {
        background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.4)), url('https://www.familijna.pl/uploads/p/2/7/7/7/po-czym-poznac-swieze-pieczywo.jpg') center/cover no-repeat;
    }
